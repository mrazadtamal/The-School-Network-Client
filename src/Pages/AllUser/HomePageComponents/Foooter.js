                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                   <div className="lg:text-left sm:text-center">
                    ...
                    <div className="mt-12 md:mt-0 lg:text-left sm:text-center">
                        ...
                        <p className="text-white pt-3 font-light">Zabarte Road, Camarin, Caloocan City<br/>
                    ...
                    <div className="mt-12 md:mt-0 lg:text-left sm:text-center">
                        ...
                        <p className="text-white pt-3 font-light">Home<br/>
                            About</p>
...
>>>>>>> 3b898bcdc8de3cf188150794f4a91603c937b788
};
