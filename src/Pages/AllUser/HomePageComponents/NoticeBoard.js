...
const NoticeBoard = () => {
    return (
        <div className="bg-yellow-300	pt-6 pb-10">
            <h2 className="pt-10 pb-10 text-center text-3xl">Important Notices and Information :</h2>

            <div className="bg-white shadow-lg rounded-lg mt-5 p-5 container mx-auto w-2/3">
                <div className="flex">
         ...
         <div className="pt-4 pb-4 text-center ">
             ...
             <button className="bg-emerald-900  p-2 pr-4 rounded-full pl-4 text-cyan-50">See All Notice</button>
             </Link>
             </div>
