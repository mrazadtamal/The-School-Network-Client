...
const NoticeBoard = () => {
  ...
  return (
    <div className="bg-yellow-300	pt-6 pb-10">
      ...
      {previousAnnouncement?.map((announcement) => (
        <div
          className="bg-white shadow-lg rounded-lg mt-5 p-5 container mx-auto w-2/3"
          data-aos="zoom-in"
        >
          <div className="lg:flex md:flex sm:flex-col mb-8 pt-5 overflow-x-auto	">
            <div className="lg:w-1/4 sm:w-1/2 text-center">
              <div className="bg-cyan-600 pl-3 pr-3 text-lime-50">June</div>
              <div className="bg-green-900	 pl-3 pr-3 text-lime-50">
                {announcement?.date}
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-left pl-4">{announcement?.description}</p>
            </div>
          </div>
