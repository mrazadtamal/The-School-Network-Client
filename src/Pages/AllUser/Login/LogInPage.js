            ...
            <div className="bg-[url('https://i.ibb.co/L9hRyK9/back-school-background-with-school-supplies-copy-space.jpg')] bg-cover ">
                ...
                <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 flex flex-col w-1/2 pt-5 mx-auto">
                    ...
                    <div className="mb-4">
                        ...
                        <input name='email' onBlur={OnBlurHandler}  className="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker" id="username" type="text" placeholder="Username"/>
                    </div>
                    <div className="mb-6">
                        <label className="block text-grey-darker text-sm font-bold mb-2" for="password">
                            Password
                        </label>
                        <input name='password' onBlur={OnBlurHandler}  className="shadow appearance-none border border-red rounded w-full py-2 px-3 text-grey-darker mb-3" id="password" type="password" placeholder="******************"/>

                    </div>
                    <div className="flex items-center justify-between">
                        <button onClick={onSubmitHandler} className="bg-cyan-500 hover:bg-cyan-900 text-blue-50  font-bold py-2 px-4 rounded-full" type="button">
                            Sign In
                        </button>
