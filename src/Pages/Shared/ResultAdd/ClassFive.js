...
const Class = () => {
    ...
    {
      firsttermCgpa = parseFloat((banglaCgpa + englishCgpa + mathCgpa + gsCgpa + religionCgpa + scienceCgpa) / 7).toFixed(2)
    }
    if(result.term === 'Second-Term')
    {
      secondtermCgpa =  parseFloat((banglaCgpa + englishCgpa + mathCgpa + gsCgpa + religionCgpa + scienceCgpa) / 7).toFixed(2)
    }
    if(result.term === 'Third-Term')
    {
      thirdtermCgpa =  parseFloat((banglaCgpa + englishCgpa + mathCgpa + gsCgpa + religionCgpa + scienceCgpa) / 7).toFixed(2)
    }

    const ResultSubmitHandler = (e) => {
        e.preventDefault()
    const newresult = {...result, banglaCgpa,englishCgpa , mathCgpa , gsCgpa , religionCgpa , scienceCgpa, firsttermCgpa, secondtermCgpa,thirdtermCgpa, Failcount3}
