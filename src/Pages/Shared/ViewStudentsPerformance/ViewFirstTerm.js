...
const ViewFirstTerm = ({result}) => {

  return (
    <>
        {
          result.class === 'class-one' || result.class === 'class-two' ? <><h1 className='text-center text-xl font-bold mt-8'>First Term Result Of {result.name}</h1>
        ...
        {
          result.class === 'class-three' || result.class === 'class-four' ? <><h1 className='text-center text-xl font-bold mt-8'>First Term Result Of {result.name}</h1>
          <div className="bg-white p-8 rounded-md w-full">
            <div>
              <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
