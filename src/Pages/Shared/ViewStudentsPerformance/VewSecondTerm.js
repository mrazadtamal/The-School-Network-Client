...
const ViewSecondTerm = ({result}) => {
  return (
    <>
        {
          result.class === 'class-one' || result.class === 'class-two' ? <><h1 className='text-center text-xl font-bold mt-8'>Second Term Result Of {result.name}</h1>
        ...
        {
          result.class === 'class-three' || result.class === 'class-four' ? <><h1 className='text-center text-xl font-bold mt-8'>Second Term Result Of {result.name}</h1>
          <div className="bg-white p-8 rounded-md w-full">
            <div>
              <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                  <table className="min-w-full leading-normal">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td className="px-5 py-5 bg-white text-sm font-bold">
                            {result.Failcount1 > 0? <p className="text-red-900 whitespace-no-wrap">Failed in {result.Failcount1} Subject</p> : <p className="text-green-900 whitespace-no-wrap font-bold">{result.secondtermCgpa}</p>}
                          </td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table className="min-w-full leading-normal">
                    ...
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td className="px-5 py-5 bg-white text-sm font-bold">
                            {result.Failcount3 > 0? <p className="text-red-900 whitespace-no-wrap">Failed in {result.Failcount3} Subject</p> : <p className="text-green-900 whitespace-no-wrap font-bold">{result.secondtermCgpa}</p>}
                          </td>
                      </tr>
                    </tbody>
                  </table>
