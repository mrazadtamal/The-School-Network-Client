...
const EditBook = () => {
  ...
  return (
    <div className="pl-8 pr-8">
        <h1 className="text-3xl text-blue-900 text-center my-8 font-bold">Edit Book Information</h1>
        <form onSubmit={OnSubmitHandler}>
            ...
            <button type='submit' className='bg-blue-900 rounded-lg my-4 text-white pl-4 pr-4 pt-2 pb-2'>UPDATE</button>
        </form>
    </div>
  );
}
