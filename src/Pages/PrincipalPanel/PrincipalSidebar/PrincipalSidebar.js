        ...
        <div className="">
            ...
            <Link to="/PrincipalDashboard/PrincipalPublishNotice">
                <p
                    className={
                        location.pathname ===
                        "/PrincipalDashboard/PrincipalPublishNotice"
                            ? "active_principal_link mt-4"
                            : "principal_sidebar_link   text-white mt-4"
                    }
                >
            ...
            <Link to="/PrincipalDashboard/PrincipalAnnouncement">
                <p
                    className={
                        location.pathname ===
                        "/PrincipalDashboard/PrincipalAnnouncement"
                            ? "active_principal_link mt-4"
                            : "principal_sidebar_link   text-white mt-4"
                    }
                >
                    {" "}
                    <HiSpeakerphone className="principal_react_icons" />{" "}
                    Announcement
                </p>
            </Link>
            ...
            <Link to="/PrincipalDashboard/PrincipalManageTeacher">
                <p
                    className={
                        location.pathname ===
                        "/PrincipalDashboard/PrincipalManageTeacher"
                            ? "active_principal_link mt-4"
                            : "principal_sidebar_link   text-white mt-4"
                    }
                >
                    {" "}
                    <GiTeacher className="principal_react_icons" /> Manage
                    Teachers
                </p>
            </Link>
            ...
            <Link to="/PrincipalDashboard/RegisterTeacher">
                <p
                    className={
                        location.pathname ===
                        "/PrincipalDashboard/RegisterTeacher"
                            ? "active_principal_link mt-4"
                            : "principal_sidebar_link   text-white mt-4"
                    }
                >
            ...
            <Link to="/PrincipalDashboard/RegisterStudent">
                <p
                    className={
                        location.pathname ===
                        "/PrincipalDashboard/RegisterStudent"
                            ? "active_principal_link mt-4"
                            : "principal_sidebar_link   text-white mt-4"
                    }
                >
            ...
            <Link to="/PrincipalDashboard/UploadPayment">
                <p
                    className={
                        location.pathname ===
                        "/PrincipalDashboard/UploadPayment"
                            ? "active_principal_link mt-4"
                            : "principal_sidebar_link   text-white mt-4"
                    }
                >
