...
import {
    GetingPreviousNotice,
    PrincipalNoticePublish,
    PublishImageNotice,
    DeleteNotice,
    PutEditNotice,
} from "../../../SchoolRedux/PrincipalSlice";
    ...
    return (
        <div style={{ width: "100%" }}>
            <h1 className="text-center mt-12 text-5xl font-bold">
                Publish Notice For Teachers
            </h1>
            <div className=" justify-center principal_notice_publish_div">
                <form
                    onSubmit={SubmitHandler}
                    className="principal_notice_publish_form mx-auto mt-8 shadow-lg shadow-indigo-500/50"
                >
                    <label className="principal_form_labels font-bold">
                        Upload Notice
                    </label>
                    <span className="principal_form_span">
                        <input
                            className="principal_file_input mt-2"
                            onBlur={(e) => setImg(e.target.files[0])}
                            type="file"
                        />
                    </span>
                    <h1 className="text-center mt-4 text-3xl font-bold text-gray-700">
                        OR
                    </h1>
                    <label className="principal_form_labels font-bold">
                        Notice Title
                    ...
                    <input
                        ...
                        className="principal_form_inputs"
                        type="text"
                    ...
                    <textarea
                        ...
                        className="principal_form_textarea"
                        as="text"
                    />
                    <button className="principal_notice_publish_btn shadow-lg shadow-indigo-500/50">
                        PUBLISH
                    </button>
                </form>
                <h1 className="text-center mt-8 text-3xl font-bold mb-8">
                    Previous Notice
                </h1>
                <div className="previous_notice_section">
                    {previousNotice?.map((notice) => (
                        <div className="previous_notice_div">
                            <h4 className="text-xl font-bold text-center text-blue-900">
                                {notice?.title}
                            </h4>
                            ...
                            <div className="button_div">
                                ...
                                <button
                                    onClick={() => EditHandler(notice._id)}
                                    className="edit_btn"
                                >
                                    EDIT
                                </button>
                                        ...
                                        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                            ...
                                            <div className="principal_notice_publish_form mx-auto mt-8 shadow-lg shadow-indigo-500/50">
                                                ...
                                                <button
                                                    ...
                                                    className="principal_notice_publish_btn shadow-lg shadow-indigo-500/50"
                                                >
                                                    SUBMIT
                                                </button>
                                            </div>
