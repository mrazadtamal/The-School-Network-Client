              ...
              <tbody>
                {
                  students?.map(student => <tr>
                    ...
                    <td  className="text-center px-5 py-5 border-b border-gray-400 bg-white text-sm">
                      <span onClick={() => {
                        navigate(`/PrincipalDashboard/IndividualPayment`, {state: student.email})
                      }} className="relative inline-block px-3 py-2 rounded-lg  cursor-pointer font-semibold text-blue-900 text-lg font-bold leading-tight bg-black text-yellow-200">
