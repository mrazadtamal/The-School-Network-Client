...
const StudentSidebar = () => {
    return (
        <div className="sm:py-10">
            <h1 className="text-4xl font-bold text-white text-center">Student Dashboard</h1>
            <div className="flex flex-col justify-center items-center">
                ...
                <NavLink to="/StudentDashboard/RequestCare"
                            style={({ isActive }) => ({
                ...
                <NavLink to="/StudentDashboard/SubmitDocuments"
                            style={({ isActive }) => ({
                                color: isActive ? '#0bc28b' : '#545e6f',
                                background: isActive ? '#7600dc' : 'black',
                            })}>
                ...
                <NavLink to="/StudentDashboard/StudentPay"
                            style={({ isActive }) => ({
                                color: isActive ? '#0bc28b' : '#545e6f',
                                background: isActive ? '#7600dc' : 'black',
                            })}>
