    ...
    return (
        <div className="bg-green-300 h-screen p-4 text-center">
            ...
            <div className="">
                ...
                <a
                    href="#"
                    className="inline-flex justify-center min-w-max rounded-md border border-gray-300 shadow-sm px-4 py-2 my-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500"
                >
                    Register Student
                </a>
            </div>
