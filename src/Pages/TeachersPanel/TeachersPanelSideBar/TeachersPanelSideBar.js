    ...
    return (
        <div className="h-screen overflow-scroll overflow-x-hidden">
            ...
            <Link to="/TeachersDashboard/Profile">
                ...
                >
                    <i className="fas fa-sticky-note principal_sidebar_icon"></i>
                    My Profile
                </p>
            </Link>
            ...
            {shown2 && (
                <ul className="drop_link">
                    ...
                    {teachersData.teacherclass === "class-five" && (
                        <li
                            onClick={() =>
                                ResultNavigateHandler("ClassFive", "Class Five")
                            }
                            className="class_text"
                        >
                            Class Five
            ...
            <Link to="/TeachersDashboard/RegisterStudent">
                <p
                    className={
                        location.pathname ===
                        "/TeachersDashboard/RegisterStudent"
                            ? "active_principal_link mt-4"
                            : "principal_sidebar_link   text-white mt-4"
                    }
                >
            ...
            <Link to="/TeachersDashboard/publishAssignment">
                <p
                    className={
                        location.pathname ===
                        "/TeachersDashboard/publishAssignment"
                            ? "active_principal_link mt-4"
                            : "principal_sidebar_link   text-white mt-4"
                    }
                >
            ...
            <Link to="/TeachersDashboard/SeeExtraRequestPage">
                <p
                    className={
                        location.pathname ===
                        "/TeachersDashboard/SeeExtraRequestPage"
                            ? "active_principal_link mt-4"
                            : "principal_sidebar_link   text-white mt-4"
                    }
                >
            ...
            {shown3 && (
                <ul className="drop_link">
                    <li
                        onClick={() =>
                            navigate("/TeachersDashboard/ClassRoutine")
                        }
                        className="class_text"
                    >
                        Class Routine
                    ...
                    <li
                        onClick={() =>
                            navigate("/TeachersDashboard/ExamRoutine")
                        }
                        className="class_text"
                    >
                        Exam Routine
