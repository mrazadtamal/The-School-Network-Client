...
export const PublishImageNotice = createAsyncThunk(
    ...
    async (fd) => {
        const response = await fetch(
            "http://localhost:5000/PublishImageNotice",
            {
                method: "POST",
...
export const GetingPreviousNotice = createAsyncThunk(
    ...
    async () => {
        const response = await fetch(
            "http://localhost:5000/PreviousNotice"
        ).then((res) => res.json());
        return response;
    }
);
...
export const PutEditNotice = createAsyncThunk(
    ...
    async (data) => {
        ...
        const response = await fetch(
            `http://localhost:5000/PutEditNotice/${data._id}`,
            {
                method: "PUT",
                headers: {
                    "content-type": "application/json",
...
export const PrincipalAnnouncementPublish = createAsyncThunk(
    ...
    async (data) => {
        console.log("hitted slice", data);
        const response = await fetch(
            "http://localhost:5000/publisAnnouncement",
            {
                method: "POST",
                headers: {
                    "content-type": "application/json",
...
export const PublishImageAnnouncement = createAsyncThunk(
    ...
    async (fd) => {
        ...
        const response = await fetch(
            "http://localhost:5000/PublishImageAnnouncement",
            {
                method: "POST",
                body: fd,
            }
...
export const GetingPreviousAnnouncement = createAsyncThunk(
    ...
    async () => {
        const response = await fetch(
            "http://localhost:5000/PreviousAnnouncement"
        ).then((res) => res.json());
        return response;
    }
);
...
export const DeleteAnnouncement = createAsyncThunk(
    ...
    async (id) => {
        const response = await fetch(
            `http://localhost:5000/DeleteAnnouncement/${id}`,
            {
                method: "DELETE",
            }
        )
...
export const PutEditAnnouncement = createAsyncThunk(
    ...
    async (data) => {
        console.log("hitted slice", data);
        const response = await fetch(
            `http://localhost:5000/PutEditAnnouncement/${data._id}`,
            {
                method: "PUT",
                headers: {
                    "content-type": "application/json",
...
export const IndividualPerformance = createAsyncThunk(
    ...
    async (id) => {
        const response = await fetch(
            `http://localhost:5000/IndividualPerformance/${id}`
        ).then((res) => res.json());
        return response;
    }
);
...
export const UploadMonthlyPayment = createAsyncThunk(
    ...
    async (data) => {
        ...
        const response = await fetch(
            "http://localhost:5000/UploadMonthlyPayment",
            {
                method: "POST",
                headers: {
                    "content-type": "application/json",
...
export const GetAllTeachers = createAsyncThunk(
    ...
    async (data) => {
        const response = await fetch(
            "http://localhost:5000/GetAllTeachers"
        ).then((res) => res.json());
        return response;
    }
);
...
export const PostAdmissionData = createAsyncThunk(
    ...
    async (data) => {
        const response = await fetch(
            "http://localhost:5000/addmissionpayment",
            {
                method: "POST",
...
export const GetlPaymentDetails = createAsyncThunk(
    ...
    async (email) => {
        const response = await fetch(
            `http://localhost:5000/GetlPaymentDetails?email=${email}`
        ).then((res) => res.json());
        return response;
    }
);
...
export const GetAdmissionForms = createAsyncThunk(
    ...
    async () => {
        const response = await fetch(
            "http://localhost:5000/GetAdmissionForms"
        ).then((res) => res.json());
        return response;
    }
);
...
export const IndividualAdmissionForm = createAsyncThunk(
    ...
    async (id) => {
        const response = await fetch(
            `http://localhost:5000/IndividualAdmissionForm/${id}`
        ).then((res) => res.json());
        return response;
    }
);
