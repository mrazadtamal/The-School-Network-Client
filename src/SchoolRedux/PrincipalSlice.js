...
export const PrincipalNoticePublish = createAsyncThunk(
    ...
    async (data) => {
        const response = await fetch(
            "https://blooming-citadel-14218.herokuapp.com/publisNotice",
            {
                method: "POST",
                headers: {
...
export const GetingPreviousNotice = createAsyncThunk(
    ...
    async () => {
        const response = await fetch(
            "https://blooming-citadel-14218.herokuapp.com/PreviousNotice"
        ).then((res) => res.json());
        return response;
    }
);
...
export const DeleteNotice = createAsyncThunk(
    ...
    async (id) => {
        const response = await fetch(
            `https://blooming-citadel-14218.herokuapp.com/DeleteNotice/${id}`,
            {
                method: "DELETE",
            }
        )
...
export const PutEditNotice = createAsyncThunk(
    ...
    async (data) => {
        ...
        const response = await fetch(
            `https://blooming-citadel-14218.herokuapp.com/PutEditNotice/${data._id}`,
            {
                method: "PUT",
                headers: {
                    "content-type": "application/json",
...
export const PrincipalAnnouncementPublish = createAsyncThunk(
    ...
    async (data) => {
        console.log("hitted slice", data);
        const response = await fetch(
            "https://blooming-citadel-14218.herokuapp.com/publisAnnouncement",
            {
                method: "POST",
                headers: {
                    "content-type": "application/json",
...
export const GetingPreviousAnnouncement = createAsyncThunk(
    ...
    async () => {
        const response = await fetch(
            "https://blooming-citadel-14218.herokuapp.com/PreviousAnnouncement"
        ).then((res) => res.json());
        return response;
    }
);
...
export const DeleteAnnouncement = createAsyncThunk(
    ...
    async (id) => {
        const response = await fetch(
            `https://blooming-citadel-14218.herokuapp.com/DeleteAnnouncement/${id}`,
            {
                method: "DELETE",
            }
        )
...
export const PutEditAnnouncement = createAsyncThunk(
    ...
    async (data) => {
        console.log("hitted slice", data);
        const response = await fetch(
            `https://blooming-citadel-14218.herokuapp.com/PutEditAnnouncement/${data._id}`,
            {
                method: "PUT",
                headers: {
                    "content-type": "application/json",
...
export const GetAllStudents = createAsyncThunk(
    ...
    async (stduentclass) => {
        const response = await fetch(
            `http://localhost:5000/GetAllStudents?studentclass=${stduentclass}`
        ).then((res) => res.json());
        return response;
    }
);
...
export const IndividualPerformance = createAsyncThunk(
    ...
    async (id) => {
        const response = await fetch(
            `https://blooming-citadel-14218.herokuapp.com/IndividualPerformance/${id}`
        ).then((res) => res.json());
        return response;
    }
);
...
export const UploadMonthlyPayment = createAsyncThunk(
    ...
    async (data) => {
        ...
        const response = await fetch(
            "https://blooming-citadel-14218.herokuapp.com/UploadMonthlyPayment",
            {
                method: "POST",
                headers: {
                    "content-type": "application/json",
...
export const GetAllTeachers = createAsyncThunk(
    ...
    async (data) => {
        const response = await fetch(
            "https://blooming-citadel-14218.herokuapp.com/GetAllTeachers"
        ).then((res) => res.json());
        return response;
    }
);
export const PrincipalReducer = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(
            PrincipalAnnouncementPublish.fulfilled,
            (state, action) => {
                Swal.fire(
                    "Success",
        ...
        builder.addCase(
            GetingPreviousAnnouncement.fulfilled,
            (state, action) => {
