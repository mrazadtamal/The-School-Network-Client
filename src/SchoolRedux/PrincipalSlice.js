...
export const GetingPreviousNotice = createAsyncThunk(
  ...
  async () => {
    const response = await fetch("http://localhost:5000/PreviousNotice").then(
      (res) => res.json()
    );
    return response;
  }
...
export const GetAllTeachers = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch("http://localhost:5000/GetAllTeachers").then(
      (res) => res.json()
    );
    return response;
  }
...
export const PostAdmissionData = createAsyncThunk(
  ...
  async (data) => {
    const response = await fetch("http://localhost:5000/addmissionpayment", {
      method: "POST",
