...
export const GetlPaymentDetails = createAsyncThunk(
  ...
  async (email) => {
    ...
    const response = await fetch(`http://localhost:5000/GetlPaymentDetails?email=${email}`).then(res=> res.json())
    return  response;
...
export const GetAdmissionForms = createAsyncThunk(
  ...
  async () => {
    const response = await fetch('http://localhost:5000/GetAdmissionForms').then(res=> res.json())
    return  response;
...
export const IndividualAdmissionForm = createAsyncThunk(
  ...
  async (id) => {
    ...
    const response = await fetch(`http://localhost:5000/IndividualAdmissionForm/${id}`).then(res=> res.json())
    return  response;
